...
describe('Marker Endpoints', () => {
  describe('GET /api/v1/markers', () => {
    test('should return empty array when no markers exist', async () => {
      ...
      const response = await app.handle(new Request('http://localhost/api/markers'))
  ...
  describe('GET /api/v1/markers/:id', () => {
    test('should return a specific marker', async () => {
      ...
      // Get the marker
      const response = await app.handle(new Request(`http://localhost/api/markers/${marker.id}`))
    ...
    test('should return 404 for non-existent marker', async () => {
      const response = await app.handle(new Request('http://localhost/api/markers/non-existent-id'))
  ...
  describe('DELETE /api/v1/markers/:id', () => {
    test('should delete a marker', async () => {
      ...
      // Verify it's deleted
      const getResponse = await app.handle(new Request(`http://localhost/api/markers/${marker.id}`))
