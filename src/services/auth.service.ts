...
import type { RegisterRequest, LoginRequest, UserWithoutPassword } from '../types'
...
export class AuthService {
  ...
  static async login(data: LoginRequest): Promise<{ user: UserWithoutPassword; token: string }> {
